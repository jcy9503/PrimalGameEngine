...
namespace PrimalEditor.GameProject
{
    ...
    {
        public ProjectTemplate(string projectType, string projectFile, List<string> folders, byte[] icon, byte[] screenshot, string iconFilePath, string screenshotFilePath, string projectFilePath)
        {
    ...
    class NewProject : ViewModelBase
    {
        ...
        private const string _templatePath = @"..\..\PrimalEditor\ProjectTemplates";
